  ...
  <div class="row justify-content-center form-container">
    <div class="col-12">
        <div class="data-container">
            {!! Form::open(['method'=>'POST', 'action'=>'AdminController@storeresponsible', 'onsubmit' => 'return validationResponsible()']) !!}
            {{ csrf_field() }}
            <div class="form-row">
                <div class="col form-group">
                    {!! Form::label('titleid', 'Nombre de Responsable', ['class'=>'col-sm-12 col-form-label']) !!}
                    <div class="col">
            ...
            <div class="form-row">
                <div class="col form-group">
                    ...
                    <div class="col">
                        {!! Form::text('email', null, ['class'=>'form-control', 'data-id' => '0']) !!}
                    </div>
                </div>
            </div>
            <div class="form-row">
